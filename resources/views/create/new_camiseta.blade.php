                    ...
                    <div class="col-6">
                        <div class="form-group" >
                            ...
                            <div class="btn-group " role="group" aria-label="Basic checkbox toggle button group">
                                ...
                                <input type="checkbox" class="btn-check" name="botonM" id="btncheck2" autocomplete="off">
        ...
        <br>
                    ...
                    <br>
                        <div class="row my-auto ">
                            <input type="file" name="imagen_frente" id="imagen_frente" class="btn btn-outline-primary align-middle">Imagen frente</input>
                        </div>    
                        <br> <br>            
                        <div class="row my-auto ">
                            <input type="file" name="imagen_atras" class="btn btn-outline-primary">Imagen atras</input>
                        </div>
                    <div>
                </div>
            </div>
